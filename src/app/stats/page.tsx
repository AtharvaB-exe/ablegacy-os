            ...
            <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.9, opacity: 0 }} className="bg-white w-full max-w-md rounded-3xl p-8 relative shadow-2xl">
              ...
              {!isAuthenticated ? (
                <div className="text-center">
                  ...
                  <p className="text-gray-500 mb-6 text-sm">Enter security code.</p>
                  <form onSubmit={handleLogin} className="flex gap-2">
                    <input type="password" placeholder="Pass: admin" value={password} onChange={(e) => setPassword(e.target.value)} className="flex-1 bg-gray-100 border border-gray-200 rounded-xl px-4 py-3 outline-none focus:border-[#666E5D]" />
                ...
                <div className="text-center">
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-2xl p-8 mb-6 cursor-pointer hover:bg-gray-50 hover:border-[#666E5D] transition-colors group">
                    {status === "idle" && <div className="flex flex-col items-center text-gray-400 group-hover:text-[#666E5D]"><Upload size={48} className="mb-2" /><span className="font-bold">Update Profile Data</span></div>}
